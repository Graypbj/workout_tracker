...
func (cfg *apiConfig) handlerStrengthTrainingSetsDelete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Couldn't delete strength training set", err)
		return
	}
